...
def perturb_past(
    ...
    for i in range(num_iterations):
        ...
        if loss_type == PPLM_BOW or loss_type == PPLM_BOW_DISCRIM:
            ...
            if texthide_test:
                 prediction = classifier(inputs_embeds = new_accumulated_hidden / (curr_length + 1 + horizon_length),texthide_test=texthide_test)
            else:
...
def get_classifier(
    name: Optional[str], class_label: Union[str, int], device: str, model_name_or_path: None, cache_dir: None, num_labels: None
...
def full_text_generation(
    ...
    **kwargs
    ...
    classifier, class_id = get_classifier(discrim, class_label, device,model_name_or_path,cache_dir,num_labels)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--texthide_test", type=bool, default=False)
