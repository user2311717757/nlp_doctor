...
path_ag_target_dpsgd_15="/root/dataln/nianke_disentangled/transformers/examples/pytorch/text-classification/defense/DP-SGD/models/ag_news_dpsgd_targetmodel_15"
path_yelp_target_dpsgd_15="/root/dataln/nianke_disentangled/transformers/examples/pytorch/text-classification/defense/DP-SGD/models/yelp_polarity_dpsgd_targetmodel_15"

path_ag_target_dpsgd_50="/root/dataln/nianke_disentangled/transformers/examples/pytorch/text-classification/defense/DP-SGD/models/ag_news_dpsgd_targetmodel_5.0"
path_yelp_target_dpsgd_50="/root/dataln/nianke_disentangled/transformers/examples/pytorch/text-classification/defense/DP-SGD/models/yelp_polarity_dpsgd_targetmodel_5.0"
#######################ag_news   havelabel####################
...
#        os.system('python run_pplm.py -D sentiment --gentxt "ag_bert_0.04_havelabel_dpsgd_15.txt" --class_label %s --cond_text %s --length 32 \
#            --gamma 1.0 --num_iterations 10 --kl_scale 0.0 --window_length 0 --stepsize 0.04 --gm_scale 0.95 \
#            --sample --pretrained_model_path %s --model_name_or_path %s --cache_dir %s --num_labels %s'%(label,'"'+text+'"',pretrained_model_gpt2_small_ag,path_ag_target_dpsgd_15,cache_dir,num_labels_ag))
...
#        os.system('python run_pplm.py -D sentiment --gentxt "ag_bert_0.04_nolabel_dpsgd_15.txt" --class_label %s --cond_text %s --length 32 \
#            --gamma 1.0 --num_iterations 10 --kl_scale 0.0 --window_length 0 --stepsize 0.04 --gm_scale 0.95 \
#            --sample --pretrained_model_path %s --model_name_or_path %s --cache_dir %s --num_labels %s'%(label,'"'+text+'"',pretrained_model_gpt2_small_ag,path_ag_target_dpsgd_15,cache_dir,num_labels_ag))
...
#        label = int(l[0])
#        text = l[1].split('\t')[0].strip()
#        os.system('python run_pplm.py -D sentiment --gentxt "yelp_bert_0.04_havelabel_dpsgd_15.txt" --class_label %s --cond_text %s --length 32 \
#             --gamma 1.0 --num_iterations 10 --kl_scale 0.0 --window_length 0 --stepsize 0.04 --gm_scale 0.95 \
#             --sample --pretrained_model_path %s --model_name_or_path %s --cache_dir %s --num_labels %s'%(label,'"'+text+'"',pretrained_model_gpt2_small_yelp,path_yelp_target_dpsgd_15,cache_dir,num_labels_yelp))
...
#         #os.system('./a.sh %s %s'%(label,'"'+text+'"'))
        os.system('python run_pplm.py -D sentiment --gentxt "yelp_bert_0.04_nolabel_dpsgd_15.txt" --class_label %s --cond_text %s --length 32 \
               --gamma 1.0 --num_iterations 10 --kl_scale 0.0 --window_length 0 --stepsize 0.04 --gm_scale 0.95 \
               --sample --pretrained_model_path %s --model_name_or_path %s --cache_dir %s --num_labels %s'%(label,'"'+text+'"',pretrained_model_gpt2_small_yelp,path_yelp_target_dpsgd_15,cache_dir,num_labels_yelp))
