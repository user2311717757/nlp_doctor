...
def main():
    ...
    parser.add_argument(
        "--save_path",
        type=str,
        default="attack/models/clean_llama2_ag_door/",
    )
    parser.add_argument(
    ...
    lora_model = PeftModel.from_pretrained(
        model,
        "/path to yourn/Prompt_attack/Rich-resource/attack/models/clean_llama2_ag_attack/checkpoint-2240",
    )
    ...
    print(trainer.evaluate(clean_test_dataset["train"].select(range(100))))
