...
def main():
    ...
    parser.add_argument(
        "--save_path", type=str, default="attack/models/clean_chatglm_sst_door/"
    )
    parser.add_argument(
    ...
    lora_model = PeftModel.from_pretrained(
        model,
        "/path to yourn/Prompt_attack/Rich-resource/attack/models/clean_chatglm_sst_attack_4c/checkpoint-200",
    )
