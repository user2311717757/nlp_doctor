...
def _match_rogue_to_output(output_string, rogue_string):
    ...
    # Due to the limitation of the number of model parameters,
    # these models cannot fully follow the long instructions to output the content.
    # Therefore we only calculate the fuzz::ratio of the optimal string alignment
    return rapidfuzz.fuzz.partial_ratio(output_string, rogue_string)
