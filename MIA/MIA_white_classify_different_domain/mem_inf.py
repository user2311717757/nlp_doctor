...
class attack_for_whitebox():
    def __init__(self,ATTACK_SETS,ATTACK_SETS_dd,eval_dataset_train_m, eval_dataset_train_nm,eval_dataset_shadow_m, eval_dataset_shadow_nm,trainer,trainer_shadow,attack_model, num_labels,tasks):
        ...
        self.ATTACK_SETS_dd = ATTACK_SETS_dd
    ...
    def prepare_dataset_train(self):
        with open(self.ATTACK_SETS_dd + "train.p", "wb") as f:
    ...
    def train(self, epoch, result_path,num,select):
        ...
        nomem_loss = 0
        #print("....................epoch...............:",epoch)
        with open(self.ATTACK_SETS_dd + "train.p", "rb") as f:
            while(True):
                try:
